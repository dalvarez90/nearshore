...
import com.banamex.nearshore.util.CitiesConstants;
...
public class PlatformController {
	...
	public Object retrieveAllPlatforms() {
		...
		requestParams.put("sql", "SELECT * FROM "+CitiesConstants.CAT_PLATAFORMA);
	...
	public Object retrievePlatformById(@PathVariable Integer id) {
		...
		requestParams.put("tipoQuery", 2);
		requestParams.put("sql", "SELECT * FROM "+CitiesConstants.CAT_PLATAFORMA+" WHERE ID = ?");
	...
	public Object newPlatform(@RequestBody Plataforma plataforma) {
		...
		requestParams.put("sql", "INSERT INTO "+CitiesConstants.CAT_PLATAFORMA+" (Id, Descripcion, Comentarios) VALUES (?, ?, ?)");
		requestParams.put("data", queryParams);
	...
	public Object editPlatform(@PathVariable Integer id, @RequestBody Plataforma plataforma) {
		...
		requestParams.put("tipoQuery", 1);
		requestParams.put("sql", "UPDATE "+CitiesConstants.CAT_PLATAFORMA+" SET Descripcion = ? , Comentarios = ? WHERE Id = ?");
		requestParams.put("data", queryParams);
	...
	public Object removePlatform(@PathVariable Integer id) {
		...
		requestParams.put("tipoQuery", 1);
		requestParams.put("sql", "DELETE FROM "+CitiesConstants.CAT_PLATAFORMA+" WHERE Id = ?");
		requestParams.put("data", queryParams);
